...
//Delays
#define tempo_curva 15

//Velocidades
#define veloc_Frente 175
#define veloc_Reverso 175
...
void tras_esquerda(){
 ...
 /*void detectaCor(){
  ...
  for (int x=0; x<10; x++) {
      ...
      if (verdeR  > 50 and verdeR < 70 and verdeL  > 50 and verdeL ){// && green_R < blue_R)
