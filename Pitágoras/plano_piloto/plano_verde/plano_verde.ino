...
if (analogRead(sensor_direito) > corteD and analogRead(sensor_esquerdo) > corteE){
    ...
    //se o verde estiver na esquerda
    if (green_E < red_E and green_E < blue_E){
    ...
    }//fecha if verde na esquerda
     
     
    
     
     //se verde estiver na direita
    ...
    while(true) {
     ...
     while(true){ 
      ...
      }//fecha if verde na direita



//Quando esquerda e direita estiverem no verde, giro
